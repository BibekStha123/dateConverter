...
class NepaliDateHelper  
{
    ...
    public function addDays($days, $date=null)
    {
        ...
        $total_days_in_month = $this->dateHelper->getDateTable($year, $month)->days_bs;
    ...
    public function addMonths($month_data, $date = null)
    {
        ...
        $total_days_in_month = $this->dateHelper->getDateTable($year, $newMonth)->days_bs;
    ...
    public function addYearHelper($newYear, $newMonth, $newDay)
    {
        ...
        if ($newMonth < 1) {
            ...
            $total_days_in_month = $this->dateHelper->getDateTable($newYear, $newMonth)->days_bs;
            if($newDay > $total_days_in_month){
                $newDay = $total_days_in_month;
    ...
    // {
    //     $dateTable = DateTable::where('year_bs', $year)->where('month_bs', $month)->first();
    //     return $dateTable;
    // }
