...
use App\Utils\NepaliDateHelper;


class SubtractNepaliDate
{
    private $date;
    private $dateHelper;
    ...
    public function subDays($days, $date=null)
    {
        ...
        $noOfDaysInMonth = $this->dateHelper->getDateTable($year, $month)->days_bs;
    ...
    public function subMonths($months, $date=null)
    {
        ...
        //must be here, other wise day will be deducted because of recursive function
        $day = $day - 1;
    ...
    public function checkMonth($newYear, $newMonth, $newDay)
    {
        ...
        if($newMonth < 1){
            $newYear--;
            $newMonth = 12;
            $noOfDaysInMonth = $this->dateHelper->getDateTable($newYear, $newMonth)->days_bs;
            $newDay = $noOfDaysInMonth;
        } else {
            $newDay = $this->dateHelper->getDateTable($newYear, $newMonth)->days_bs;
        }
    ...
    public function subAll($years, $months, $days)
    {
        ...
        $nepaliDate = new NepaliDateHelper($dateAfterYears);
        return $nepaliDate->addDays(1);
    }
